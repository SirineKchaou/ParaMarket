                                    ...
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" >
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="modifierAdmin.php?id=<?php echo $donnees['id'] ?>" class="btn btn-success">Modifier</a>
                                                    <a href="Controller/suppAdmin.php?id=<?php echo $donnees['id'] ?>" class="btn btn-danger">Supprimer</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            </tbody>
