                                    ...
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" >
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $donnees['stocke'] ?></td>
                                                <td><?php echo $donnees['prix'] ?></td>
                                                <td><?php echo $donnees['description'] ?></td>
                                                <td><img
                                                style="width: 40px; height: 40px;"
                                                 src='uploads/<?php echo $donnees['image'] ?>'/></td>
                                                <td>
                                                    <a href="modifierProduit.php?id=<?php echo $donnees['id'] ?>" class="btn btn-success">Modifier</a>
                                                    <a href="Controller/suppProduit.php?id=<?php echo $donnees['id'] ?>" class="btn btn-danger">Supprimer</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            </tbody>
