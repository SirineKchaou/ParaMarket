                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php
                                                 include('includes/connect_db.php');
                                                $req_admin = $bdd->query("SELECT count(id) as total_admin from admin");
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php
                                                 include('includes/connect_db.php');
                                                $req_client = $bdd->query("SELECT count(id) as total_client from client");
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php
                                                 include('includes/connect_db.php');
                                                $req_produit = $bdd->query("SELECT count(id) as total_produit from produit");
                                                $donnees_produit = $req_produit->fetch();

                                                echo $donnees_produit['total_produit'];
                                                             ?></span></h4>
                                            <p class="text-muted mb-0">Produit</p>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col-->
